...
class KiTS1(Dataset):
    ...
    def __init__(self, base_dir=None,list_dir=None, split='train', patch_size=(128,128,64), num=None, transform=None):
        ...
        # self.image_list = [os.path.join(data_path, item + ".h5") for item in self.image_list]
...
class KiTS2(Dataset):
    """ KiTS Dataset """
    # base_dir="../data/processed_v1_h5"
    def __init__(self, base_dir=None, split='train', patch_size= (128,128,64), num=None,):
        self._base_dir = base_dir
        self.sample_list = []
        tr_transform = Compose([
            RandomCrop(patch_size),
        ...
        if 'train' in split:
            with open('../data/KiTS19/train.txt', 'r') as f:
                self.image_list = f.readlines()
                self.transform = tr_transform
        elif split == 'test':
            with open('../data/KiTS19/test.txt', 'r') as f:
                self.image_list = f.readlines()
                self.transform = test_transform
