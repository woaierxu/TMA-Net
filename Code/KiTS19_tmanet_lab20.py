...
from utils.testGPT import fuse_label_by_sdf_3d
...
parser.add_argument('--root_path', type=str, default=r'/data1/mengqingxu/Dataset/KiTS19/KiTS19-SSL/', help='Name of Dataset')
parser.add_argument('--model', type=str, default='BiomedVNet', help='model_name')
...
parser.add_argument('--labelnum', type=int, default=38, help='trained samples')
...
#  --setting of Diff-ESSPIL
parser.add_argument('--ess_patch_size',type = int, default=2,help= 'the patch size for ESS loss')
parser.add_argument('--ess_weights',type = list, default=[0.4, 0.6, 0.8],help= 'the diffenent weights for differnt region of ESS loss')
parser.add_argument('--noise_scale',type = float, default=0.0,help= 'the noise scale added in predicted prob during PIL')
    ...
    for epoch_num in iterator:
        ...
        if epoch_num % 10 == 0:
            ...
            dice_sample = test_3d_patch.var_all_case_LA(model_bcp, num_classes=num_classes, patch_size=patch_size,
                                                        stride_xy=32, stride_z=32, text_embed=text_embed,dataset="KiTS19")
            ...
            if dice_sample2 > best_dice2:
                ...
                logging.info(
                    "save best resnet model to {}, iter: {}, dice: {}".format(save_best_path, iter_num, best_dice2))
            model_nobcp.train()
    ...
    for i_epoch, epoch in enumerate(iterator):
        ...
        if epoch % 10 == 0:
            ...
            if mean_dice_sample > mean_best_dice:
                ...
                logging.info(
                    "mean save best model to {}, iter: {}, dice: {}".format(save_best_path1, iter_num, mean_best_dice))
...
if __name__ == "__main__":
    ...
    def is_script_running(script_name):
        ...
        for proc in psutil.process_iter(['name', 'cmdline']):
            try:
                ...
                continue
        return False
    TARGET_SCRIPT = "LA_10_DESSPIL_SST_addDiceLossInDiffU_valDice.py"
    while True:
    ...
    pre_snapshot_path = "./model/KiTS19/{}/pre_train".format(args.exp)
    self_snapshot_path = "./model/KiTS19/{}/self_train".format(args.exp)
    print("Starting Diff-ESSPIL training.")
    for snapshot_path in [pre_snapshot_path, self_snapshot_path]:
        if not os.path.exists(snapshot_path):
            os.makedirs(snapshot_path)
    # copy train files
    shutil.copyfile(__file__, f"./model/KiTS19/{args.exp}/{args.exp}.py")



    # -- Pre-Training
    if False:
        pre_snapshot_path = f'./model/KiTS19/KiTS19_20_SOTA8_fuseFeatureGate/pre_train'
